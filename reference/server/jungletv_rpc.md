...
| `sender`  | [User](./common_types.md#user-object)? | The authenticated user originating this event or invocation, will be undefined if the operation originates from an unauthenticated visitor.                                                                                                                                                                                                                                         |
